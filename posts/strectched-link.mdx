...
紀錄網頁開發常見的 clickable block ，個人認為較符合 a11y 的作法，大致需求如下

<img
  width="896"
  height="212"
  alt="voicetube-trending-videos-ui"
  src="/images/voicetube-trending-videos-ui.png"
/>

- 點擊卡片後，跳轉至該影片頁面
- 點擊卡片上的 tag 後， 跳轉至對應主題的影片列表頁
- 點擊卡片上的愛心 icon button， 收藏影片
...
後來才發現 `bootstrap@4.x` 開始，就有提供名為 [stetched link](https://getbootstrap.com/docs/5.2/helpers/stretched-link/#content) 的 css helper
...
[bootstrap - stretched link](https://getbootstrap.com/docs/5.2/helpers/stretched-link/#content)
